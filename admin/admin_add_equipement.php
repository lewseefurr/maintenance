...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_query($conn, "INSERT INTO equipements (nom, description, statut) 
                         VALUES ('$nom', '$description', '$statut')");
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-plus-circle"></i> Ajouter un équipement</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
