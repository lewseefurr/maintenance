...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    mysqli_query($conn, "INSERT INTO users (nom, username, password, role) 
                         VALUES ('$nom', '$username', '$password', '$role')");
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-person-plus"></i> Ajouter un utilisateur</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-secondary">Créer l'utilisateur</button>
